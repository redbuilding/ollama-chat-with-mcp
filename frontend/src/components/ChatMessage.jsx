    ...
    <div className={`flex animate-slide-up ${isUser ? 'justify-end' : 'justify-start'} mb-4 group`}>
      ...
      <div
        ...
        className={`max-w-[80%] p-3 rounded-lg shadow ${
          ...
          isUser ? 'bg-brand-blue text-white rounded-br-none' : 'bg-brand-surface-bg text-brand-text-primary
rounded-bl-none'
      ...
      >
        ...
        <button
          ...
          className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 mt-2 flex items-center
text-xs p-1 rounded hover:bg-opacity-20 hover:bg-gray-500"
